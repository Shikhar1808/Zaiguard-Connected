"""fl_project: FedProx Client App for Zaiguard Embedding Classification."""
...
from src.fl.tasks.classification_embeddings_prox import train as train_fn
...
def train(msg: Message, context: Context):
    ...
    # Call the training function (using Focal Loss)
...
def evaluate(msg: Message, context: Context):
    ...
    # Call the evaluation function (using Focal Loss)
