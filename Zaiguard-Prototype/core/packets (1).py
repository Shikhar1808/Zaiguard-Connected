...
class TrackBox(BaseModel):
    ...
    area_px: int
    aspect_ratio: float
    appearance_embedding: list[float] = Field(default_factory=list)   # 128-d stub
...
class AlertEmbeddings(BaseModel):
    appearance_embedding: list[float] = Field(default_factory=list)   # 128-d
    spatial_embedding: list[float] = Field(default_factory=list)      # [cx_norm, cy_norm]
    trajectory_embedding: list[float] = Field(default_factory=list)   # future
